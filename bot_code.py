...
class MyClient(discord.Client):
    ...
    async def check_issues(self):
        ...
        for repo in self.ROIs:
            ...
            if s:
                ...
                await channel.send("⠀") # There is a magical special blank character here. Please be aware!
    ...
    def git_open_issues(self,repo):
        ...
        r = requests.get("https://api.github.com/repos/zotbins/{}/issues".format(repo), params=payload,headers=header)
    ...
    async def on_message(self,message):
        ...
        if message.content.startswith('/help'):
            with open('./templates/help.txt') as f:
            ...
            for repo in self.ROIs:
                ...
                if s:
                    ...
                    await message.channel.send("⠀") # There is a magical special blank character here. Please be aware!
                else:
                    await message.channel.send("No new issues for **{}** today 🌱".format(repo))
